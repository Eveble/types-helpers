...
export class StandardizedMixin {
  ...
  public static convert(
    ...
    const standard = this.getStandard(otherStandardId) as types.Standard<any>;
    if (standard.isConvertible === true) {
      return standard.convert(code, identifiedStandard as types.Standard<any>);
    }
    return undefined;
  }
}
